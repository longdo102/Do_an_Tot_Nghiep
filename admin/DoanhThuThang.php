...
<body class="theme-red">
    ...
    <section class="content">
        <div class="container-fluid">
           ...
           function getRevenueLast12Months($con) {
            $data = [];
            for ($i = 11; $i >= 0; $i--) {
                ...
                $sql = "SELECT SUM((od.quantity * p.price_new) - (od.quantity * p.price_nhap)) as revenue
                        ...
                        WHERE DATE_FORMAT(o.created_time, '%Y-%m') = '$date'
                        AND o.status IN (1, 2)";
        ...
        $revenue_data = getRevenueLast12Months($con);
        ?>

        <div class="row clearfix">
            <div class="row">
                <div class="font-bold m-b-33 text-center">DOANH THU 12 THÁNG QUA</div>
            </div>
